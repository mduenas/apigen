...
public class apigenactivity extends Activity implements View.OnClickListener, OnGestureListener
{
	...
	public boolean onTouchEvent(MotionEvent event)
	{
		...
		boolean result = doubleTapListener.onTouchEvent(event);// return the
																// double tap
																// events
		return result;
	...
	public class simpleOnScaleGestureListener extends SimpleOnScaleGestureListener
	{
		...
		public boolean onScale(ScaleGestureDetector detector)
		{
			...
			// tvPi.setTextSize((float)
			// (tvPi.getTextSize()*detector.getScaleFactor() * 0.5));
		...
		public void onScaleEnd(ScaleGestureDetector detector)
		{
			...
			// tvScale.setText(String.format("Scale %s: Text: %s",
			// String.valueOf(tvPi.getTextSize()*scale), tvPi.getTextSize()));
	...
	class FetchSecuredResourceTask extends AsyncTask<String, Void, String>
	{
		...
		{
			// stringPi =
			// "<html><body><div style='width: 200px;word-wrap:break-word;'>";
			// stringPi += result;
