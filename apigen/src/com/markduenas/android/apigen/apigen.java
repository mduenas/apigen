...
public class apigen extends Activity implements View.OnClickListener, OnGestureListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //wvPi = (WebView)findViewById(R.id.wvPi);
        ...
        tvPi.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				 ...
				 try {
				     ...
				     Toast.makeText(apigen.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
				 }
				return false;
			}
		});
        ...
        if(savedInstanceState != null) {
        	...
        	//stringPi = "<html><body><div>3.</div></body></html>";
        	stringPi = "3.";
    ...
    protected void onSaveInstanceState(Bundle outState) { 
      ...
      outState.putString("generatedPi", tvPi.getText().toString());
    }
    /**
	...
	class FetchSecuredResourceTask extends AsyncTask<String, Void, String>
	{
		 ...
		 {
			 pd = ProgressDialog.show(apigen.this, "Working...", "Generating Pi", true, false);
		 }
